...
N = abs(int(input('Укажите язык -> 1 - Английский; 0 - Русский: ')))
word = input('Введите слово: ').upper()
if N == 1:
	print('За данное слово вы получаете', sum([k for i in word for k, v in eng.items() if i in v]), 'очков')
elif N == 0:
	print('За данное слово вы получаете', sum([k for i in word for k, v in rus.items() if i in v]), 'очков')